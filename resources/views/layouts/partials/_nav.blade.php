<!-- Main navbar -->
<div class="header-navbar navbar navbar-expand-md navbar-dark bg-primary-800 navbar-static">
    <div class="navbar-brand" style="min-width:auto;">
        <a href="/" class="d-inline-block">
            <img src="https://tsaas.textronic.online/tailori2d/images/tailori-logo.png" alt="">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="navbar-nav ml-md-auto">
            ...
            <li class="nav-item">
                <a href="#" class="navbar-nav-link" href="{{ route('logout') }}"
