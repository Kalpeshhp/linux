        ...
        <table style="border-bottom: 1px solid #bebebe;padding: 20px 0;" cellpadding="0" cellspacing="0" width="100%" >
          <tr>
            ...
            <td  align="right" style="width:50%;vertical-align: top;">
              <a href="{{env('APP_URL')}}" style="color: #808080;text-decoration: none;">login to customtailorsstore.com</a>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td>
        <table  style="border-bottom: 1px solid #bebebe;padding-bottom: 10px;margin-bottom: 20px;" cellpadding="0" cellspacing="0" width="100%" >
          <tr>
            <td>
              <h3 style="margin-top: 0;font-size: 23px;font-weight: 400;">Hey {{$name}},</h3>
              <p style="color: #808080;">Your account has been activated <span style="color:#000000">CustomTailorsStore</span></p>
              <p style="color: #808080;">Please login to store to start customization</p>

              <a style="width: 100%; background: #3d3f92;color: #fff;float: left;text-align: center; padding: 15px; border-radius: 5px;font-size: 21px;margin: 30px 0;">Login</a>
            </td>
          </tr>
        </table>
