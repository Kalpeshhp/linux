        ...
        <table  style="border-bottom: 1px solid #bebebe;padding-bottom: 10px;margin-bottom: 20px;" cellpadding="0" cellspacing="0" width="100%" >
          <tr>
            <td>
              ...
              <p style="color: #808080;">Thanks for registering an account with <span style="color:#000000">CustomTailorsStore</span></p>
              <p style="color: #808080;">Please confirm that testing@gmail.com address by clicking on the button</p>

              <a style="width: 100%; background: #3d3f92;color: #fff;float: left;text-align: center; padding: 15px; border-radius: 5px;font-size: 21px;margin: 30px 0;">Verify</a>
            </td>
          </tr>
        </table>
